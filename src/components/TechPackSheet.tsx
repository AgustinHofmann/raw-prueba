...
export default function TechPackSheet({ project, designer, garmentImg, measures, onClose }: Props) {
  const [notes, setNotes] = useState('Tela: jersey de algodón 180gr. Costuras: overlock. Cuello: ribb 1x1. Etiqueta interior estampada.')
  const [bom, setBom] = useState('• Tela principal — algodón 100%\n• Hilo — poliéster tono a tono\n• Etiqueta de marca — tejida')
